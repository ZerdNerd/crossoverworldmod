...
NGame = {
	...
	HANDS_OFF_START_TAG = "UNC",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
},
...
NDiplomacy = {
	...
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 0, -- Base factor for taking state you do not control
	BASE_PEACE_TAKE_FACTION_CONTROLLED_STATE_FACTOR = 0, -- Base factor for taking state you do not control, but someone in faction does
	BASE_PEACE_FORCE_GOVERNMENT_COST = 250, 		-- Base cost for forcing a country to change government.
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.1,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.3,				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
	...
	TENSION_ANNEX_NO_CLAIM = 0,						-- Amount of tension generated by annexing a state you don't have claims on
	TENSION_ANNEX_CLAIM = 0,						-- Amount of tension generated by annexing a state you DO have claims on
	...
	TENSION_VOLUNTEER_FORCE_DIVISION = 0,			-- Amount of tension generated for each sent division
	TENSION_DECAY = 0.1,							-- Each months tension decays this much
	TENSION_SIZE_FACTOR = 0,						-- All action tension values are multiplied by this value
	...
	PEACE_SCORE_PER_PASS = 0.75,						-- When you pass in a peace deal you gain this percent of your original score
	...
	TAKE_STATES_LIBERATE_COST_MULT = 1500,			-- Cost multiplier for feeding states to a country that has been liberated, assuming the country has cores on the states
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.5,			-- ideology limit required to join faction
...
NCountry = {
	...
	BASE_STABILITY_PARTY_POPULARITY_FACTOR = 0.10,	-- Default stability rulling party popularity factor
	...
	STATE_OCCUPATION_COST_MULTIPLIER = 0.25,		-- Multiplier for state value to PP cost for occupation
...
NAI = {
	...
	MAX_VOLUNTEER_ARMY_FRACTION = 0.3,			-- Countries will not send more than their forces time this number to aid another country
	...
	SEND_VOLUNTEER_EVAL_BASE_DISTANCE = 1000.0,  -- How far away it will evaluate sending volunteers if not a major power
	...
	ENEMY_HOME_AREA_RATIO_TO_DISABLE_INVASIONS = 1.0, -- if we are fighting against an enemy home area from our home area and if the enemy area is larger than this ratio, non strategy invasions are disabled
	...
	MAX_DISTANCE_NALAV_INVASION = 300.0,				-- AI is extremely unwilling to plan naval invasions above this naval distance limit.
	...
	NAVAL_INVADED_AREA_PRIO_MULT = 4.0,									-- fronts that belongs to recent invasions gets more prio
