...
NAI = {
	...
	MAX_DISTANCE_NAVAL_INVASION = 300.0,				-- AI is extremely unwilling to plan naval invasions above this naval distance limit.
...
NCharacter = {
	...
	SPECIALIST_ADVISOR_MIN_RANK = 1,
	EXPERT_ADVISOR_MIN_RANK = 3,
